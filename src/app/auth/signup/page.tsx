        ...
        <div className="min-h-screen relative flex items-center justify-center p-4 bg-[#0c0a14] overflow-y-auto">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute inset-0" style={{
                    background: 'radial-gradient(ellipse at 80% 30%, rgba(232, 145, 79, 0.1) 0%, transparent 50%), radial-gradient(ellipse at 20% 70%, rgba(124, 92, 252, 0.12) 0%, transparent 50%), radial-gradient(ellipse at 50% 50%, rgba(155, 122, 255, 0.06) 0%, transparent 60%)',
                }} />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-[#1a1528]/60 backdrop-blur-xl border border-[#2d2545]/50 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-[#7c5cfc]/5">
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-[#f5f0eb] mb-1">Create an account</h2>
                        <p className="text-[#a39484] text-sm">Start your reading journey today</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs">
                                <span className="px-4 bg-[#1a1528] text-[#a39484] rounded-full">Or sign up with email</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSignup} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-xs font-medium text-[#a39484] mb-1.5">Password</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-[#a39484]/60">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full bg-gradient-to-r from-[#7c5cfc] to-[#9b7aff] hover:from-[#6a45e8] hover:to-[#7c5cfc] text-white font-bold py-3 rounded-xl shadow-lg shadow-[#7c5cfc]/25 flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98] text-sm"
                            >
                                {isLoading ? (
                                    <>
                    ...
                    <p className="text-center text-[#a39484] text-xs mt-6">
                        ...
                        <Link href="/auth/login" className="text-[#f5f0eb] hover:text-[#9b7aff] font-semibold transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
